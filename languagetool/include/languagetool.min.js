...
// Declare Variables
 ...
 var sgstore = { html:{}, text:{}, obj:{}, lt:{}, lock:{}, run:[], contextmenu:{}, ignore:{ once:{}, all:{}, rule:{}, categories:{}}, queue:[[],[],[]], dqueue:{}, iaqueue:{}, progress:[0,0,0,0], issues:{}, enabled: true  }; // Universal Storage
...
// Context Menu
 ...
 function lt_openContextMenu (e) {
    ...
    if ( $(mynode).hasClass('lt-highlight') == true ) {
        ...
        var pageX = e.clientX + $('#'+sgfunc['id'].call()+'_ifr').offset().left;
        var pageY = e.clientY + $('#'+sgfunc['id'].call()+'_ifr').offset().top;
        ...
        lt_debug( "DEBUG|1="+pageX+"="+pageY+'='+$('#'+sgfunc['id'].call()+'_ifr').contents().scrollTop()+'='+$('#'+sgfunc['id'].call()+'_ifr').offset().top+'='+e.clientY, 5 );
        // right of window
...
function lt_contextMenuClick(uuid,hid,value,mode) {
    ...
    if (lt_showProgressBar == true) {
    var progressbar = $( sgfunc['progress_container'].call() ).find('span');

    $(progressbar).html( $( sgfunc['body'].call() ).find('.lt-highlight').length + ' Issue(s)'  );
    }
