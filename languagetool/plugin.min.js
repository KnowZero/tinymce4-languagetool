...
var lastnode;
 ...
 editor.on('contextmenu', function(e) {
    ...
    if ( /hl[rgnybop][0-9]/.test($(mynode).attr('class')) == true ) {
        ...
        var pageX = e.clientX + $('#editor-content_ifr').offset().left;
        var pageY = e.clientY + $('#editor-content_ifr').offset().top;
        ...
        lt_debug( "DEBUG|1="+pageX+"="+pageY+'='+$('#editor-content_ifr').contents().scrollTop()+'='+$('#editor-content_ifr').offset().top+'='+e.clientY, 5 );
        // right of window
