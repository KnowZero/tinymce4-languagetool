...
var statusbar = editor.theme.panel && editor.theme.panel.find('#statusbar')[0];
 ...
 var sgstore = { html:{}, text:{}, obj:{}, lt:{}, lock:{}, run:[], contextmenu:{}, ignore:{ once:{}, all:{}, rule:{}}, queue:[[],[],[]], dqueue:{}, progress:[0,0,0,0], issues:{}, enabled: true  }; // Universal Storage
 ...
 var timerFunc = function() {
    ...
    if ( timerRunner >= lt_remoteTimer && Object.keys(listInstances).length < lt_maxInstances ) {
        ...
        $.each(sgstore['dqueue'],function(key,val) {
            if (  val[0]+3000 < (new Date).getTime()  ) {
        ...
        var tsize=0;
        var ikey=getUUID();
        listInstances[ikey]={ text:'', size:0 };
       ...
       sgstore['queue'][i] = $.grep(sgstore['queue'][i], function(key,i) {
            ...
            if (  key in sgcheck  ) {
                ...
                var val=sgcheck[ key ];
                    ...
                    if ( listInstances[ikey]['text'] == '' || (listInstances[ikey]['text'].length+tval.length) < lt_sizeOfInstances ) {
                        listInstances[ikey]['text']=listInstances[ikey]['text']+tval;
                        tsize++;  
...
$(progress_bar).val( sgstore['progress'][0] );
 ...
 function lt_delayed_queue ( uuid, mynode, qlvl, newline ) {
    sgstore['dqueue'][uuid]=[ (new Date).getTime(), mynode, qlvl, newline ];
 }
