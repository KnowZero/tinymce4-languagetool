                                    ...
                                    body: [
                                        {
                                            ...
                                            items: [
                                                { name: 'ignore_rules', id: 'lt_ignoreRulesCfg', type: 'selectbox', size: 10, label: 'Rules', options: Object.keys(sgstore['ignore']['rule']) },
                                                {
                                                    ...
                                                    onclick: function(e) { var val = $("#lt_ignoreRulesCfg").val(); delete(sgstore['ignore']['rule'][val]);  lt_ignoreCallback.call('removeRule',val);   $("#lt_ignoreRulesCfg option:selected").remove();  }
                                                },
...

                                                {
                                                    ...
                                                    onclick: function(e) { var val = $("#lt_ignoreWordsCfg").val(); delete(sgstore['ignore']['all'][val]);  lt_ignoreCallback.call('removeWord',val);   $("#lt_ignoreWordsCfg option:selected").remove();  }
                                                }
