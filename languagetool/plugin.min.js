...
//editor.execCommand('mceReplaceContent',false,$(this).data("ident-value") );
 ...
 editor.on('PreInit', function () {
    editor.serializer.addNodeFilter('span', function (nodes) {
        ...
        while (i--) {
            ...
            if ( node.hasClass('lt-highlight') == true || node.hasClass('lt-highlight-remove') == true ) {
                node.unwrap();
            }
 ...
 function setUUID (mynode) {
    ...
    if ( (lt_ignoreBlockTags[mynode.nodeName]||0) == 0 ) {
...
//lt_debug("mode="+mode);
 ...
 function lt_new_content_process (e) {
    ...
    if ( $(mynode).css('display') == 'inline' || lt_ignoreBlockTags[mynode.nodeName] == 1 || nodeExc[mynode.nodeName] == 1 ) {
